...
public class AlbumContentFragment extends Fragment {
    ...
    public static AlbumContentFragment newInstance(String bucketId, String bucketName) {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        String folderName = getArguments() != null ? getArguments().getString(ARG_BUCKET_NAME) : "Album";
    ...
    private List<MediaItem> fetchFrom(Uri collection, boolean isVideo) {
        ...
        String bucketId = getArguments() != null ? getArguments().getString(ARG_BUCKET_ID) : null;

        if (bucketId == null) return list;
    ...
    private void updateSortSelection(Button selected) {
        ...
        for (Button b : Arrays.asList(btnAll, btnDays, btnMonths, btnYears)) {
            b.setTextColor(b == selected ? Color.BLACK : Color.GRAY);
        }
    }
}